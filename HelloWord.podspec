...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhaofakai/HelloWord'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhaofakai' => 'zhaofakai@baidu.com' }
  s.source           = { :git => 'https://github.com/zhaofakai/HelloWord.git', :tag => s.version.to_s }
